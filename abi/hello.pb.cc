...
const uint32_t TableStruct_hello_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::helloworld::HelloRequest, _impl_.id_),
  PROTOBUF_FIELD_OFFSET(::helloworld::HelloRequest, _impl_.title_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::helloworld::HelloReply, _impl_.status_),
};
...
const ::_pbi::DescriptorTable descriptor_table_hello_2eproto = {
    false, false, 194, descriptor_table_protodef_hello_2eproto,
    "hello.proto",
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "helloworld.HelloRequest.title"));
        } else
          goto handle_unusual;
        continue;
      default:
